...
;(function($) {
    $.fn.formset = function(opts)
    {
            ...
            */
            ...
            insertDeleteLink = function(row) {
                ...
                row.find('a.' + delCssSelector).click(function() {
                    var row = $(this).parent('div').parent('div').parents('.' + options.formCssClass),
        ...
        if ($$.length) {
            ...
            var addButtonHTML = '<a role="button" class="' + options.addCssClass + '" href="javascript:void(0)">' + options.addText + '</a><br>';
